...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white flex flex-col font-sans selection:bg-blue-500 selection:text-white">
      ...
      {/* CTA Footer Section */}
      <footer className="mt-auto py-10 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
          ...
          <div>
            Built with React, TypeScript, Vite & Tailwind CSS. Ready for Express + MongoDB backend integration.
          </div>
        </div>
      </footer>
    </div>
